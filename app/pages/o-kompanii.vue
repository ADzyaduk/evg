...
<template>
  <div>
    <UPageHero
      v-animate
      title="О компании"
      description="Швейное производство полного цикла и поставки тканей. Берём на себя всё: разработку, пошив, упаковку и доставку."
          ...
          <div class="flex flex-col gap-4">
            ...
            <div>
              ...
              <p class="text-sm mt-3 leading-relaxed">
                ...
                Эта фабрика позволяет нам браться за крупные партии: когда объём заказа велик,
                мы распределяем работу между площадками и сохраняем привычное качество на каждой из них.
              </p>
            </div>
          </div>
        </UCard>
